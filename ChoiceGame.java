...
public class ChoiceGame extends JPanel implements ActionListener, KeyListener, MouseListener, MouseMotionListener {
	...
	//images
	ImageIcon background = new ImageIcon(getClass().getResource("/qhacks2025//images//fantacy background.gif"));
	ImageIcon Slide1 = new ImageIcon(getClass().getResource("/qhacks2025//images//Slide_1.gif"));
	ImageIcon CaveOfTruth = new ImageIcon(getClass().getResource("/qhacks2025//images//CaveOfTruth.png"));
	ImageIcon truth = new ImageIcon(getClass().getResource("/qhacks2025//images//truth.png"));
	ImageIcon lie = new ImageIcon(getClass().getResource("/qhacks2025//images//lie.png"));
	ImageIcon Friends3 = new ImageIcon(getClass().getResource("/qhacks2025//images//3Friends.jpg"));
	ImageIcon DarkPath = new ImageIcon(getClass().getResource("/qhacks2025//images//darkPath.jpg"));
	ImageIcon LightPath = new ImageIcon(getClass().getResource("/qhacks2025//images//lightPath.jpg"));
	ImageIcon greed = new ImageIcon(getClass().getResource("/qhacks2025//images//greed.png"));
	ImageIcon save = new ImageIcon(getClass().getResource("/qhacks2025//images//save.png"));
	ImageIcon evilSteal = new ImageIcon(getClass().getResource("/qhacks2025//images//evil steal.png"));
	ImageIcon evilSlide = new ImageIcon(getClass().getResource("/qhacks2025//images//EvilSlide.png"));
	ImageIcon evilHandShake = new ImageIcon(getClass().getResource("/qhacks2025//images//evilHandShake.jpg"));
	ImageIcon Fistbump = new ImageIcon(getClass().getResource("/qhacks2025//images//fistbump.png"));	
	ImageIcon CliffForest = new ImageIcon(getClass().getResource("/qhacks2025//images//CliffForest.jpg"));
	ImageIcon glowMushroom = new ImageIcon(getClass().getResource("/qhacks2025//images//glowShroom.png"));
	ImageIcon wizardSwirl = new ImageIcon(getClass().getResource("/qhacks2025//images//cartoonWizard.png"));
	ImageIcon goodCastle = new ImageIcon(getClass().getResource("/qhacks2025//images//goodCastle.jpg"));
	ImageIcon darkCastle = new ImageIcon(getClass().getResource("/qhacks2025//images//darkCastle.png"));
	ImageIcon dragon = new ImageIcon(getClass().getResource("/qhacks2025//images//dragon.png"));
	ImageIcon fight = new ImageIcon(getClass().getResource("/qhacks2025//images//fight.jpg"));
	ImageIcon running = new ImageIcon(getClass().getResource("/qhacks2025//images//running.jpg"));
	ImageIcon troll = new ImageIcon(getClass().getResource("/qhacks2025//images//troll.jpg"));
	ImageIcon blind = new ImageIcon(getClass().getResource("/qhacks2025//images//blind.png"));
	ImageIcon married = new ImageIcon(getClass().getResource("/qhacks2025//images//married.png"));
	ImageIcon potion = new ImageIcon(getClass().getResource("/qhacks2025/images/potion.jpg"));
	ImageIcon reject = new ImageIcon(getClass().getResource("/qhacks2025/images/reject.png"));
	...
	public void paintComponent(Graphics g) {
		...
		g.drawString("choose wisely,for the path shapes the wizard within.\"", 120, 750);
		}
		...
		if(Slide == Friends3) {
			...
			if(storeOption == 2) {
				...
				g.drawString("The ground beneath you collapses and", 100, 400);
				...
				g.drawString("truthfull and the Hypogriff taught you ", 100, 400);
			...
			if(storeOption == 2) {
				...
				g.drawString("hit with a nausea potion", 100, 500);
			}else if(storeOption == 1) {
				g.setColor(new Color(2, 2, 2,150));
				g.drawRect(100, 300, 1150, 300);
				g.fillRect(100, 300, 1150, 300);
		...
		if (slideScreen) {
			...
			if(Slide == greed) {
			    ...
			    g.drawString("their glowing magical within reach", 50, 150);
			    ...
			    g.drawString("a truthfull hypogriff which asks", 50, 250);
			    ...
			    g.drawString("supplies at the cusp of a forest and", 50, 150);
		    ...
		    if (Slide == dragon) {
			    ...
			    g.drawString("Your friend looks to you, What will you do?", 50, 200);
		    ...
		    if (Slide == troll) {
			    ...
			    g.drawString("a single on the boat. Why?", 50, 300);
			    ...
			    g.drawString("to join him in becoming a dark wizard.", 50, 200);
				...
				g.drawString("After your dreading journey", 580, 350);
